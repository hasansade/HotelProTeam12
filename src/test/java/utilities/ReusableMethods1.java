...
public class ReusableMethods1 {
    ...
    public static void login() {
        ...
        loginPage.usernameBox.sendKeys(ConfigReader.getProperty("fUserName"));
        loginPage.passwordBox.sendKeys(ConfigReader.getProperty("fPassword"));
